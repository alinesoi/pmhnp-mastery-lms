...
function DashLeftMenu() {
  ...
  // Sleep to Thrive: hide modules Ahna doesn't use to keep the dash simple
      ...
      <div className="flex-1 flex flex-col justify-center py-4 px-3">
        <AdminAuthorization authorizationMode="component">
          <div className="space-y-1">
            ...
            {showOtherMenu && (!showCommunities || !showPodcasts || !showBoards || !showPlaygrounds || !showPayments) && (
              <HoverMenu
                content={
                  <HoverMenuContent className="w-64">
