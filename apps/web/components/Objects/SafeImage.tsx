...
export function isValidMediaUrl(url: string): boolean {
  ...
  try {
    // Base makes root-relative paths (e.g. /content/...) parse instead of
    // throwing; they inherit the base's http: protocol and pass the check,
    // while javascript:/data: URLs keep their own protocol and are rejected.
    const parsed = new URL(url, 'http://relative-url.local')
